...
export const MUTABLE_PATH_DENY_SUBSTRINGS = [
    ...
    'src/services/llm/tools/discord/',
    'src/services/llm/routing/EventRouter.ts',
    'src/services/memory/',
    'src/services/minebot/runtime/memoryContext.ts',
    'src/services/minebot/runtime/MinebotTaskRuntime.ts',
    'src/services/minebot/config/MinebotConfig.ts',
    'src/services/minebot/client.ts',
    'src/services/minebot/skillAgent.ts',
    'src/services/common/adapters/minebotAdapter.ts',
