...
const allowed = { access: ['access'], modelSettings: ['access', 'modelSettings'], execution: ['execution'], memory: ['memory'], conversation: ['conversation'], radar: ['radar'], fca: ['fca'], identity: ['access', 'identity'] };
const errors = [];
...
else console.log('Foundation boundaries passed (access, modelSettings, execution, memory, conversation, radar, fca, identity)');
