...
const allowed = { access: ['access'], modelSettings: ['access', 'modelSettings'], execution: ['execution'] };
const errors = [];
...
else console.log('Foundation boundaries passed (access, modelSettings, execution)');
